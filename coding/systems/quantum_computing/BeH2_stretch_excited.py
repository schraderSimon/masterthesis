"""
Based on UCC2 sampling data, find EVC values for linear stretch of BeH2 using the noS-approach.
"""
import sys
...
UCC_UCC2_params=loadmat("energy_data/BeH2_params_EXCITED_UCC2_new.mat")
...
file="energy_data/UCC2_BeH2_stretch_noS.bin"
import pickle
